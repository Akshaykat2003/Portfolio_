...
const Hero = () => {
  return (
    <div className="py-12 px-2 max-w-4xl m-auto sm:pt-24">
        ...
        As a self-taught front-end software developer with a passion for responsive web design, 
        I specialize in creating engaging web applications using HTML5, CSS3, JavaScript, Next.js, React.js, Firebase, and RESTful APIs. 
        With over 2 years of experience working on Team Projects and personal projects, 
        I continually refine my skills to deliver innovative and user-friendly solutions.
        </p>
        <div className="my-7 flex justify-start items-center gap-4 flex-wrap">
          <button className="bg-teal-500 py-2 px-4 font-bold text-white border-2 border-teal-500 rounded-md ease-in-out duration-150 hover:text-white hover:bg-transparent hover:border-white" title="View Resume">
            <a href="https://drive.google.com/file/d/1xUuUdo5eLuVqnADUtLLH27xtKgOEJWnT/view?usp=sharing"  className="flex justify-start items-center gap-1">
